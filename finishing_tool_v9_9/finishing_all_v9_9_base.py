...
# param21 = ap.GetParameterAsText(21)
# param22 = ap.GetParameterAsText(22)
#sdepull = ap.GetParameter(19)
#dataload = ap.GetParameter(20)
    # self.params[21].value = ['Default Bridge WID Updater', 'Default Pylon HGT Updater', 'Building in BUA Descaler', 'CACI Swap Scale and CTUU']
    # self.params[22].value = ['Database Feature Report', 'Source Analysis Report']
    # if self.params[21].value == set_null:
    #     self.params[21].value = ['']
    # if self.params[22].value == set_null:
    #     self.params[22].value = ['']
