...
# Export of toolbox C:\Users\njcagle\AppData\Roaming\ESRI\Desktop10.6\ArcToolbox\My Toolboxes\Finishing Tool Suite.tbx

import arcpy

class Toolbox(object):
    def __init__(self):
        self.label = u'Finishing Tool Suite'
        self.alias = ''
        self.tools = [finishall]

# Tool implementation code

class finishall(object):
    """C:\Users\njcagle\AppData\Roaming\ESRI\Desktop10.6\ArcToolbox\My Toolboxes\Finishing Tool Suite.tbx\finishall"""
    import arcpy
    class ToolValidator(object):
      ...
      def initializeParameters(self):
        ...
        self.params[0].category = ""
        self.params[1].category = ""
        self.params[2].category = "1 Data Maintenance Tools"
        self.params[3].category = "1 Data Maintenance Tools"
        self.params[4].category = "1 Data Maintenance Tools"
        self.params[5].category = "1 Data Maintenance Tools"
        self.params[6].category = "1 Data Maintenance Tools"
        self.params[7].category = "2 Feature Specific Tools"
        self.params[8].category = "2 Feature Specific Tools"
        self.params[9].category = "2 Feature Specific Tools"
        self.params[10].category = "2 Feature Specific Tools"
        self.params[11].category = "3 Geometry Correction Tools"
        self.params[12].category = "3 Geometry Correction Tools"
        self.params[13].category = "4 Preprocessing Tools"
        self.params[14].category = "4 Preprocessing Tools"
        self.params[15].category = "4 Preprocessing Tools"
        self.params[16].category = "4 Preprocessing Tools"
        self.params[17].category = "5 Database Management Tools"
        self.params[18].category = "5 Database Management Tools"
        return
    ...
    def __init__(self):
        self.label = u'Finishing Tool v9.6'
        self.description = u'Finishing Tool Suite version 9 is here!!! ### Building in BUA Descaler now changes FFN list depending on if TDS is CACI or not.'
        self.canRunInBackground = False
    def getParameterInfo(self):
        # TDS____The_standard_Finishing_process_is_checked_by_default_____Tools_are_run_in_list_order_
        param_1 = arcpy.Parameter()
        param_1.name = u'TDS____The_standard_Finishing_process_is_checked_by_default_____Tools_are_run_in_list_order_'
        param_1.displayName = u'TDS   (The standard Finishing process is checked by default)   (Tools are run in list order)'
        param_1.parameterType = 'Required'
        param_1.direction = 'Input'
        param_1.datatype = u'Feature Dataset'

        # ⠀⠀⠀__Skip_Buildings
        param_2 = arcpy.Parameter()
        param_2.name = u'\u2800\u2800\u2800__Skip_Buildings'
        param_2.displayName = u'\u2800\u2800\u2800- Skip Buildings'
        param_2.parameterType = 'Required'
        param_2.direction = 'Input'
        param_2.datatype = u'Boolean'
        param_2.value = u'false'

        # Repair_All_NULL_Geometries
        param_3 = arcpy.Parameter()
        param_3.name = u'Repair_All_NULL_Geometries'
        param_3.displayName = u'Repair All NULL Geometries'
        ...
        param_4.name = u'Populate_F_Codes'
        param_4.displayName = u'Populate F_Codes'
        ...
        param_5.name = u'Calculate_Default_Values'
        param_5.displayName = u'Calculate Default Values'
        param_5.parameterType = 'Required'
        param_5.direction = 'Input'
        param_5.datatype = u'Boolean'
        param_5.value = u'true'

        # Calculate_Metrics
        param_6 = arcpy.Parameter()
        param_6.name = u'Calculate_Metrics'
        param_6.displayName = u'Calculate Metrics'
        ...
        param_7.name = u'Update_UFI_Values'
        param_7.displayName = u'Update UFI Values'
        param_7.parameterType = 'Required'
        param_7.direction = 'Input'
        param_7.datatype = u'Boolean'
        param_7.value = u'true'

        # ⠀⠀⠀__Integrate_Large_Datasets
        param_8 = arcpy.Parameter()
        param_8.name = u'\u2800\u2800\u2800__Integrate_Large_Datasets'
        param_8.displayName = u'\u2800\u2800\u2800- Integrate Large Datasets'
        param_8.parameterType = 'Required'
        param_8.direction = 'Input'
        param_8.datatype = u'Boolean'
        param_8.value = u'false'

        # Integrate_and_Repair_Hydro
        param_9 = arcpy.Parameter()
        param_9.name = u'Integrate_and_Repair_Hydro'
        param_9.displayName = u'Integrate and Repair Hydro'
        param_9.parameterType = 'Required'
        param_9.direction = 'Input'
        param_9.datatype = u'Boolean'
        param_9.value = u'true'

        # Integrate_and_Repair_Trans
        param_10 = arcpy.Parameter()
        param_10.name = u'Integrate_and_Repair_Trans'
        param_10.displayName = u'Integrate and Repair Trans'
        param_10.parameterType = 'Required'
        param_10.direction = 'Input'
        param_10.datatype = u'Boolean'
        param_10.value = u'true'

        # Integrate_and_Repair_Utilities
        param_11 = arcpy.Parameter()
        param_11.name = u'Integrate_and_Repair_Utilities'
        param_11.displayName = u'Integrate and Repair Utilities'
        param_11.parameterType = 'Required'
        param_11.direction = 'Input'
        param_11.datatype = u'Boolean'
        param_11.value = u'true'

        # Delete_Identical_Features
        param_12 = arcpy.Parameter()
        param_12.name = u'Delete_Identical_Features'
        param_12.displayName = u'Delete Identical Features'
        param_12.parameterType = 'Required'
        param_12.direction = 'Input'
        param_12.datatype = u'Boolean'
        param_12.value = u'true'

        # Explode_all_Multipart_Features
        param_13 = arcpy.Parameter()
        param_13.name = u'Explode_all_Multipart_Features'
        param_13.displayName = u'Explode all Multipart Features'
        param_13.parameterType = 'Required'
        param_13.direction = 'Input'
        param_13.datatype = u'Boolean'
        param_13.value = u'true'

        # Default_Bridge_WID_Updater__Now_with_added_Tunnels___
        param_14 = arcpy.Parameter()
        param_14.name = u'Default_Bridge_WID_Updater__Now_with_added_Tunnels___'
        param_14.displayName = u'Default Bridge WID Updater (Now with added Tunnels!!)'
        param_14.parameterType = 'Required'
        param_14.direction = 'Input'
        param_14.datatype = u'Boolean'
        param_14.value = u'false'

        # Default_Pylon_HGT_Updater
        param_15 = arcpy.Parameter()
        param_15.name = u'Default_Pylon_HGT_Updater'
        param_15.displayName = u'Default Pylon HGT Updater'
        param_15.parameterType = 'Required'
        param_15.direction = 'Input'
        param_15.datatype = u'Boolean'
        param_15.value = u'false'

        # Building_in_BUA_Descaler
        param_16 = arcpy.Parameter()
        param_16.name = u'Building_in_BUA_Descaler'
        param_16.displayName = u'Building in BUA Descaler'
        param_16.parameterType = 'Required'
        param_16.direction = 'Input'
        param_16.datatype = u'Boolean'
        param_16.value = u'false'

        # CACI_Swap_CTUU_and_Scale____Reminder__This_will_be_run_in_the_order_it_appears_in_the_checked_list_
        param_17 = arcpy.Parameter()
        param_17.name = u'CACI_Swap_CTUU_and_Scale____Reminder__This_will_be_run_in_the_order_it_appears_in_the_checked_list_'
        param_17.displayName = u'CACI Swap CTUU and Scale   (Reminder: This will be run in the order it appears in the checked list)'
        param_17.parameterType = 'Required'
        param_17.direction = 'Input'
        param_17.datatype = u'Boolean'
        param_17.value = u'false'

        # Feature_Count_Report
        param_18 = arcpy.Parameter()
        param_18.name = u'Feature_Count_Report'
        param_18.displayName = u'Feature Count Report'
        param_18.parameterType = 'Required'
        param_18.direction = 'Input'
        param_18.datatype = u'Boolean'
        param_18.value = u'false'

        # Source_Analysis_Report
        param_19 = arcpy.Parameter()
        param_19.name = u'Source_Analysis_Report'
        param_19.displayName = u'Source Analysis Report'
        param_19.parameterType = 'Required'
        param_19.direction = 'Input'
        param_19.datatype = u'Boolean'
        param_19.value = u'false'

        # Top_Secret_Finishing_Version____Don_t_click_this_____Definitely_not_an_easter_egg_
        param_20 = arcpy.Parameter()
        param_20.name = u'Top_Secret_Finishing_Version____Don_t_click_this_____Definitely_not_an_easter_egg_'
        param_20.displayName = u"Top Secret Finishing Version   (Don't click this)   (Definitely not an easter egg)"
        param_20.parameterType = 'Required'
        param_20.direction = 'Input'
        param_20.datatype = u'Boolean'
        param_20.value = u'false'

        return [param_1, param_2, param_3, param_4, param_5, param_6, param_7, param_8, param_9, param_10, param_11, param_12, param_13, param_14, param_15, param_16, param_17, param_18, param_19, param_20]
    def isLicensed(self):
        return True
    ...
    def execute(self, parameters, messages):
        with script_run_as(u'C:\\Projects\\njcagle\\R&D\\7_Scripts\\Projects\\Finishing-Tool-Suite\\finishing_tool_v9_5.py'):
            # -*- coding: utf-8 -*-
            # ====================== #
            # Finishing Tool v9.6    #
            ...
            ''''''''' User Parameters '''''''''
            TDS = parameters[0].valueAsText
            arcpy.env.workspace = TDS
            workspace = os.path.dirname(arcpy.env.workspace)
            arcpy.env.overwriteOutput = True
            vogon = parameters[1] # Skips large building datasets
            repair = parameters[2]
            fcode = parameters[3]
            defaults = parameters[4]
            metrics = parameters[5]
            ufi = parameters[6]
            large = parameters[7] # Running chunk processing for integrating large datasets
            hydro = parameters[8]
            trans = parameters[9]
            util = parameters[10]
            dups = parameters[11]
            explode = parameters[12]
            bridge = parameters[13]
            pylong = parameters[14]
            building = parameters[15] # Be sure to add Structure Srf and Pnt back if vogon is checked
            swap = parameters[16]
            fcount = parameters[17]
            vsource = parameters[18]
            #sdepull = parameters[19]
            #dataload = parameters[20]
            secret = parameters[19] ### update index as needed
            error_count = 0
            featureclass = arcpy.ListFeatureClasses()
            
            # argv = tuple(parameters[i].valueAsText
