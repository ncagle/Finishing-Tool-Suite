# feature_report_mod.py refactored from John Jackson's Feature_Itemized_Counter.py by Nat Cagle
# 2021-12-10
...
results = results_Path+"\\"+TPCname+"_Feature_Report_"+str(time_stamp)+".txt" ######################################## os path join
...
with open(results,'w') as txtFile: ################################################## Alphabetize output
    line = []
