...
def bridgewid ():
   ...
   try:
      ...
      if sde_connect == 1:
         ...
         arcpy.MakeFeatureLayer_management("TransportationGroundCurves", "bridge_crv_lyr")
         arcpy.MakeFeatureLayer_management("TransportationGroundCurves", "road_crv_lyr")
         arcpy.MakeFeatureLayer_management("TransportationGroundCurves", "rail_crv_lyr")
   ...
   total_bridges = int(arcpy.management.GetCount("fc_bridgeR").getOutput(0)) + int(arcpy.management.GetCount("fc_bridgeRR").getOutput(0))
