...
hydro = arcpy.GetParameter(7)
hlarge = arcpy.GetParameter(8)
trans = arcpy.GetParameter(9)
tlarge = arcpy.GetParameter(10)
util = arcpy.GetParameter(11)
ularge = arcpy.GetParameter(12)
dups = arcpy.GetParameter(13)
explode = arcpy.GetParameter(14)
error_count = 0
...
if metrics:
	...
	for fc in featureclass:
		try:
			...
			arcpy.CalculateMetrics_defense(fc, metric_type, "LZN", "WID", "ARA", "#", "", 0.03)
		except arcpy.ExecuteError:
			# if the code failed for the current fc, check the error
			error_count += 1
			write("\n***Failed to run {0}.***\n".format(tool_name))
...
if explode:
	...
	try:
		...
		write("No in_class or out_class created. Continuing...")
		pass
