...
# Important FFN List from Leidos Project 8 USA
ffn_list_all = { 'Public Administration' : 808,
				'Government' : 811,
...
while building: # Needs updating from management geoprocessing to cursors
	...
	write("\n".join("{}: {}".format(k, v) for k, v in ffn_list_current.items()))
...
while swap:
	...
	write("\n--- {0} ---\n".format(tool_name))
	field_check = arcpy.ListFields(featureclass[0])
	caci_schema = False
...
while swap:
	...
	write("\nNote: The SAX_RX9 field will be populated with 'Scale Swapped' after the 'Scale' field has been swapped to the 'CTUU' field. This is assuming that the source data scale values were in the 'Scale' field when this tool was run the first time.\n")
	...
	for fc in featureclass:
		write("Swapping CTUU and Scale fields for {0}".format(fc))
...
#
# ____ _  _ ____ _ ____ _  _ ____ _  _    ___  ____ ____ _  _
# |    |__| |__| | |__/ |\/| |__| |\ |    |__] |  | |    |_/
# |___ |  | |  | | |  \ |  | |  | | \|    |__] |__| |___ | \_
#
#
...
# (_______) |         (_)                          (____  \            | |
#  _      | |__  _____ _  ____ ____  _____ ____     ____)  ) ___   ____| |  _
# | |     |  _ \(____ | |/ ___)    \(____ |  _ \   |  __  ( / _ \ / ___) |_/ )
# | |_____| | | / ___ | | |   | | | / ___ | | | |  | |__)  ) |_| ( (___|  _ (
#  \______)_| |_\_____|_|_|   |_|_|_\_____|_| |_|  |______/ \___/ \____)_| \_)
#
#
#   _______        _                       ___           __
#  / ___/ /  ___ _(_)_____ _  ___ ____    / _ )___  ____/ /__
# / /__/ _ \/ _ `/ / __/  ' \/ _ `/ _ \  / _  / _ \/ __/  '_/
# \___/_//_/\_,_/_/_/ /_/_/_/\_,_/_//_/ /____/\___/\__/_/\_\
#
#
...
#    _____ _           _                              ____             _
#   / ____| |         (_)                            |  _ \           | |
#  | |    | |__   __ _ _ _ __ _ __ ___   __ _ _ __   | |_) | ___   ___| | __
#  | |    | '_ \ / _` | | '__| '_ ` _ \ / _` | '_ \  |  _ < / _ \ / __| |/ /
#  | |____| | | | (_| | | |  | | | | | | (_| | | | | | |_) | (_) | (__|   <
#   \_____|_| |_|\__,_|_|_|  |_| |_| |_|\__,_|_| |_| |____/ \___/ \___|_|\_\
#
#
# ╔═╗┬ ┬┌─┐┬┬─┐┌┬┐┌─┐┌┐┌  ╔╗ ┌─┐┌─┐┬┌─
# ║  ├─┤├─┤│├┬┘│││├─┤│││  ╠╩╗│ ││  ├┴┐
...
# \_   ___ \|  |__ _____  |__|______  _____ _____    ____   \______   \ ____   ____ |  | __
# /    \  \/|  |  \\__  \ |  \_  __ \/     \\__  \  /    \   |    |  _//  _ \_/ ___\|  |/ /
# \     \___|   Y  \/ __ \|  ||  | \/  Y Y  \/ __ \|   |  \  |    |   (  <_> )  \___|    <
#  \______  /___|  (____  /__||__|  |__|_|  (____  /___|  /  |______  /\____/ \___  >__|_ \
#         \/     \/     \/                \/     \/     \/          \/            \/     \/
#
#
#                 -..
...
# 	return str(dict).replace(', ','\r\n').replace("u'","").replace("'","").replace("$","    ").replace("!","        - ").replace("*","            > ")[1:-1]
# cur_list = dictToString(ffn_list_current)
# write(u"{0}".format(cur_list))
# for key in ffn_list_current.keys():
# 	write("{0}: {1}".format(key, ffn_list_current[key]))
